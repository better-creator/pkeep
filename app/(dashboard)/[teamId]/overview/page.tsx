...
const urgentItems = [
  { type: 'blocker', project: '올리브영 S/S 캠페인', message: '클라이언트 피드백 7일 미응답 — 옥외 제작 블로킹', dday: 'D-14' },
  { type: 'blocker', project: '올리브영 S/S 캠페인', message: '인스타 릴스 BGM 저작권 미확인', dday: 'D-14' },
  { type: 'blocker', project: '토스 브랜드 웹툰', message: '시즌1 캐릭터 설정과 시즌2 디자인 충돌', dday: 'D-45' },
  { type: 'warning', project: '무신사 FW 룩북', message: '포토그래퍼 결정 3일 지연 — 촬영 일정 영향', dday: 'D-28' },
  { type: 'feedback', project: '삼성 갤럭시 체험존', message: '클라이언트 최종 확인 필요 (D-5)', dday: 'D-5' },
]

...
const mockTimelineItems: TimelineItem[] = [
  // ── 화면/산출물 노드 ──
  {
    ...
    title: '인스타 피드 시안 (3차)',
    date: '2026-03-20',
    description: '인스타그램 피드용 정사각형 1:1 시안, 코랄 오렌지 메인 컬러 적용, 제품 촬영 컷 배치. ⚠️ 검증 결과: 텍스트 오버레이 규정 위반 감지.',
    owner: users.park,
    hasBlocker: true,
  ...
  },
  {
    ...
    date: '2026-03-10',
    description: '제품 촬영 기본 세팅: 화이트 배경, 좌측 45도 키라이트, 우측 리플렉터 보조광. ⚠️ 산출물 검증: 라이팅 50도로 추정, 가이드 45도와 차이.',
    status: 'confirmed',
    hasBlocker: true,
    owner: users.han,
    contributors: [users.geum],
  ...
  },
  {
    ...
    date: '2026-03-25',
    description: '모델 촬영본 보정 기준: 피부 톤을 따뜻하게 보정하되, 피부 결 등 과도한 보정은 금지. ⚠️ DEC-002 촬영 라이팅과 톤 불일치 감지됨.',
    status: 'confirmed',
    hasConflict: true,
    owner: users.han,
